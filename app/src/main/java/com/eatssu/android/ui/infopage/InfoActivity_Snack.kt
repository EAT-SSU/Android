...
class InfoActivity_Snack : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getRestaurantInfo(RestaurantType.SNACK_CORNER)
    }
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        body?.let {
                            ...
                            viewBinding.tvSnackLocation.text = it.location

                            viewBinding.tvSnackWeek.text = it.openHours[0].dayType
                            viewBinding.tvSnackLunch.text = it.openHours[0].timepart
                            viewBinding.tvSnackTime.text = it.openHours[0].time
                        }
