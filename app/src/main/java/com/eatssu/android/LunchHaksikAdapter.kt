...
class LunchHaksikAdapter (val itemList: ArrayList<Haksik>) :
    RecyclerView.Adapter<LunchHaksikAdapter.HaksikViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HaksikViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_haksik_lunch, parent, false)
